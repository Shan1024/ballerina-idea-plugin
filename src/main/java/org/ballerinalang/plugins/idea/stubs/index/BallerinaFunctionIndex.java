...
public class BallerinaFunctionIndex extends StringStubIndexExtension<BallerinaFunctionDefinition> {
    ...
    public static final StubIndexKey<String, BallerinaFunctionDefinition> KEY =
            StubIndexKey.createIndexKey("ballerina.function");
    ...
    @NotNull
    @Override
    public StubIndexKey<String, BallerinaFunctionDefinition> getKey() {
        return KEY;
    }

    @NotNull
    public static Collection<BallerinaFunctionDefinition> find(@NotNull String name, @NotNull Project project,
                                                               @Nullable GlobalSearchScope scope,
                                                               @Nullable IdFilter idFilter) {
        return StubIndex.getElements(KEY, name, project, scope, idFilter, BallerinaFunctionDefinition.class);
    }

    public static boolean process(@NotNull String name, @NotNull Project project, @Nullable GlobalSearchScope scope,
                                  @Nullable IdFilter idFilter,
                                  @NotNull Processor<BallerinaFunctionDefinition> processor) {
        return StubIndex.getInstance().processElements(KEY, name, project, scope, idFilter,
                BallerinaFunctionDefinition.class, processor);
    }
}
