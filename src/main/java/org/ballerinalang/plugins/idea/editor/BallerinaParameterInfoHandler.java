...
public class BallerinaParameterInfoHandler implements ParameterInfoHandlerWithTabActionSupport {
    ...
    public static Object findElement(@NotNull PsiElement element, @Nullable PsiElement prevElement) {
        ...
        if (functionInvocation != null) {
            //            BallerinaFunctionNameReference functionNameReference = functionInvocation
            // .getFunctionNameReference();
            ...
            //                        return resolvedElement.getParent().getParent();
            //                    }
            //                }
            //            }
        ...
        //        // If the element at offset is ), that means we are at the end of a parameter list. Ex:- setData
        // (name,|)
        ...
        //            // If the parent is an ActionInvocationNode, Connector will be resolved instead of the action
        // if we get
        //            // the FunctionReferenceNode here. We need to get the FunctionReferenceNode because otherwise
        // the nested
        //            // function
        ...
        //                }
        //            }
        //            // If a FunctionReferenceNode is not found, get the element at previous offset. This will most
        // probably
        //            // contain "(".
        //            if (prevElement != null) {
        //                element = prevElement;
        ...
        //            return node;
        //        }
        //        // If the node is still null and the current element is (, that means we are at a empty (). So we
        // check for
        ...
        //            return node;
        //        }
        //        if (prevElement != null && prevElement.getText().matches("[{,]") || prevElement instanceof
        // LeafPsiElement) {
    ...
    public void showParameterInfo(@NotNull Object element, @NotNull CreateParameterInfoContext context) {
        ...
        //        // This method will be called with the return object of the findElementForParameterInfo().
        // If it is
        // null,
        ...
        //            // By doing this, we get the function name because setName("WSO2") is also a
        // ExpressionNode.
        //            PsiElement parent = PsiTreeUtil.getParentOfType(expressionListNode,
        // FunctionInvocationNode.class);
        //            // If the parent is null, that means there is no parent ExpressionListNode. That can
        // happen if
        // the parent
        //            // node is a FunctionInvocationNode.
        //            if (parent == null) {
        //                // So if the parent is null, we consider the FunctionInvocationNode as the parent
        // node.
        ...
        //
        //        if (currentElement == null || nameIdentifier == null || !(nameIdentifier instanceof
        // IdentifierPSINode)) {
        //            return;
        //        }
        //
        ...
        //        }
        //
        //        // Sometimes we might not be able to resolve elements. In that case, we should not show "No
        // parameters"
    ...
    //                parent = PsiTreeUtil.getParentOfType(expressionListNode, ExpressionNode.class);
    //            }
    //            // If the parent is null, that means there is no parent ExpressionListNode. That can happen if the
    // parent
    //            // node is a FunctionInvocationNode.
    //
    //            if (parent == null) {
    ...
    //                namedIdentifierDefNode = PsiTreeUtil.findChildOfType(anyIdentifierNameNode, IdentifierPSINode
    // .class);
    //            }
    //        }
    ...
    public static int getCurrentParameterIndex(@NotNull Object o, int offset) {
        ...
        if (o instanceof BallerinaFunctionInvocation) {
            ...
            //                    BallerinaPsiImplUtil.getCallableUnitSignature(functionInvocation);
            //            if (callableUnitSignature != null) {
            //                BallerinaFormalParameterList formalParameterList = callableUnitSignature
            ...
            //
            //
            //                PsiElement elementAtOffset = functionInvocation.findElementAt(offset);
        ...
        //        // This method updates parameter index node. This will be used to highlight the current parameter
        // in the
        //        // parameter popup.
        //        PsiElement element;
        ...
        //            ExpressionListNode expressionListNode = PsiTreeUtil.getChildOfType(parent, ExpressionListNode
        // .class);
        ...
        //            StatementNode statementNode = PsiTreeUtil.getParentOfType((IdentifierPSINode) o, StatementNode
        // .class);
        ...
        //            // Ex:- setName(|"WSO2")
        //            // In the above example, if we consider the caret position as X, child text offset is X+1. Then
        // the
        ...
        //        }
        //        // Ex:- setName("WSO2"|)
        //        // In the above example, "psiElement.getTextOffset() <= childTextOffset" condition is false. The child
        // node
        //        // ("WSO2") is not a LeafPsiElement. So the index does not get incremented in the for loop. At this
        // point,
        //        // the index is 0 which is correct. This can be other than 0 depending on the number of parameters. So
        // we set
    ...
    public static String updatePresentation(Object p, @NotNull ParameterInfoUIContext context) {
        ...
        //            // These will be used to identify which parameter is selected. This will be highlighted in the
        // popup.
        //            int start = 0;
        //            int end = 0;
        //            StringBuilder builder = new StringBuilder();
