...
public class BallerinaAnnotator implements Annotator {
    ...
    public void annotate(@NotNull PsiElement element, @NotNull AnnotationHolder holder) {
        ...
        //        } else if (element instanceof SingleBackTickDocInlineCodeNode || element instanceof
        // DoubleBackTickInlineCodeNode
    ...
    //            }
    //        }
    //        // At this point, match might not be found for query params since the annotation attachment for the
    // parameter
    ...
    //    }
    //
    //    private void annotateArrayLengthField(@NotNull VariableReferenceNode element, @NotNull AnnotationHolder
    // holder) {
