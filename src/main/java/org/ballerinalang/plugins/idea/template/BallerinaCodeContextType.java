...
public abstract class BallerinaCodeContextType extends TemplateContextType {
    ...
    public static class Service extends BallerinaCodeContextType {
        ...
        protected boolean isInContext(@NotNull PsiElement element) {
            ...
            //            }
            //
            //            if (element.getParent() instanceof PsiErrorElement || element.getParent() instanceof
            // NameReferenceNode) {
            ...
            //                    }
            //                }
            //                resourceDefinitionNode = PsiTreeUtil.getParentOfType(prevVisibleLeaf,
            // ResourceDefinitionNode.class);
            ...
            //                    ServiceDefinitionNode serviceDefinitionNode = PsiTreeUtil.getParentOfType
            // (originalElement,
    ...
    //                } else {
    //                    callableUnitBodyNode = PsiTreeUtil.getParentOfType(originalElement, CallableUnitBodyNode
    // .class);
    //                }
    //            } else {
    ...
    //                    IElementType elementType = ((LeafPsiElement) nextVisibleLeaf).getElementType();
    //                    if (elementType == BallerinaTypes.RBRACE) {
    //                        ConnectorDefinitionNode connectorDefinitionNode = PsiTreeUtil.getParentOfType
    // (originalElement,
    ...
    public static class Function extends BallerinaCodeContextType {
        ...
        protected boolean isInContext(@NotNull PsiElement element) {
            ...
            // NameReferenceNode) {
            //                PsiElement prevVisibleLeaf = PsiTreeUtil.prevVisibleLeaf(element);
            //                functionDefinitionNode = PsiTreeUtil.getParentOfType(prevVisibleLeaf,
            // FunctionDefinitionNode.class);
