...
public class BallerinaFieldReference extends BallerinaCachedReference<BallerinaIdentifier> {

    public BallerinaFieldReference(@NotNull BallerinaIdentifier element) {
        super(element);
    }
