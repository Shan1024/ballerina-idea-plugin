...
public class BallerinaEmptyTagImpl extends BallerinaCompositeElementImpl implements BallerinaEmptyTag {
  ...
  @Override
  @NotNull
  public List<BallerinaAttribute> getAttributeList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, BallerinaAttribute.class);
  }
  ...
  @Override
  @NotNull
  public PsiElement getXmlTagSlashClose() {
    return notNullChild(findChildByType(XML_TAG_SLASH_CLOSE));
  }
