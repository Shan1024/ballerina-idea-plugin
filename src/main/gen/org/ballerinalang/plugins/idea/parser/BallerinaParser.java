...
public class BallerinaParser implements PsiParser, LightPsiParser {
  ...
  public void parseLight(IElementType t, PsiBuilder b) {
    ...
    else if (t == OUTPUT_EVENT_TYPE) {
      r = OutputEventType(b, 0);
    }
  ...
  /* ********************************************************** */
  // service | resource | function | struct | enum | endpoint | const | TYPE_PARAMETER | annotation {
  ...
  public static boolean AttachmentPoint(PsiBuilder b, int l) {
    ...
    if (!r) r = AttachmentPoint_8(b, l + 1);
    exit_section_(b, l, m, r, false, null);
    return r;
  }
  ...
  //     /*recoverWhile=AttachmentPointRecover*/
  // }
  private static boolean AttachmentPoint_8(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "AttachmentPoint_8")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeToken(b, ANNOTATION);
    r = r && AttachmentPoint_8_1(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }
  ...
  //     /*recoverWhile=AttachmentPointRecover*/
  // }
  private static boolean AttachmentPoint_8_1(PsiBuilder b, int l) {
    return true;
  }
  ...
  public static boolean BuiltInTypeName(PsiBuilder b, int l) {
    ...
    r = AnyTypeName(b, l + 1);
    if (!r) r = BuiltInTypeName_1(b, l + 1);
  ...
  // SimpleTypeName (LEFT_BRACKET RIGHT_BRACKET)+
  private static boolean BuiltInTypeName_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "BuiltInTypeName_1")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = SimpleTypeName(b, l + 1);
    r = r && BuiltInTypeName_1_1(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }

  // (LEFT_BRACKET RIGHT_BRACKET)+
  private static boolean BuiltInTypeName_1_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "BuiltInTypeName_1_1")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = BuiltInTypeName_1_1_0(b, l + 1);
    int c = current_position_(b);
    while (r) {
      if (!BuiltInTypeName_1_1_0(b, l + 1)) break;
      if (!empty_element_parsed_guard_(b, "BuiltInTypeName_1_1", c)) break;
      c = current_position_(b);
    }
    exit_section_(b, m, null, r);
    return r;
  ...
  // LEFT_BRACKET RIGHT_BRACKET
  private static boolean BuiltInTypeName_1_1_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "BuiltInTypeName_1_1_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
  ...
  /* ********************************************************** */
  // !(NULL_LITERAL|int|string|float|boolean|blob|any|map|table|function|stream|'}'|';'|var |while|match|foreach|next|break|fork|try|throw|return|abort|fail|lock|xmlns|transaction|but|if|forever|check)
  ...
  /* ********************************************************** */
  // function LEFT_PARENTHESIS FormalParameterList? RIGHT_PARENTHESIS EQUAL_GT LambdaReturnParameter? CallableUnitBody
  public static boolean LambdaFunction(PsiBuilder b, int l) {
    ...
    r = p && report_error_(b, consumeTokens(b, -1, RIGHT_PARENTHESIS, EQUAL_GT)) && r;
    r = p && report_error_(b, LambdaFunction_5(b, l + 1)) && r;
    r = p && CallableUnitBody(b, l + 1) && r;
    exit_section_(b, l, m, r, p, null);
    return r || p;
  }
  ...
  private static boolean LambdaFunction_5(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "LambdaFunction_5")) return false;
  ...
  /* ********************************************************** */
  // TypeName identifier (ASSIGN SimpleLiteral)? (COMMA | SEMICOLON)
  ...
  public static boolean OutputEventType(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "OutputEventType")) return false;
    boolean r;
    Marker m = enter_section_(b, l, _NONE_, OUTPUT_EVENT_TYPE, "<output event type>");
    r = parseTokens(b, 0, ALL, EVENTS);
    if (!r) r = parseTokens(b, 0, EXPIRED, EVENTS);
    if (!r) r = parseTokens(b, 0, CURRENT, EVENTS);
    exit_section_(b, l, m, r, false, null);
    return r;
  }
  ...
  //     |   not PatternStreamingEdgeInput (and PatternStreamingEdgeInput | for STRING_TEMPLATE_TEXT)
  ...
  // and PatternStreamingEdgeInput | for STRING_TEMPLATE_TEXT
  private static boolean PatternStreamingInput_3_2(PsiBuilder b, int l) {
    ...
    if (!r) r = parseTokens(b, 0, FOR, STRING_TEMPLATE_TEXT);
    exit_section_(b, m, null, r);
    return r;
  }
  ...
  /* ********************************************************** */
  // !(DOCUMENTATION_TEMPLATE_START|DEPRECATED_TEMPLATE_START|'@'|public|type|typedesc|struct|service|function|enum|annotation|transformer|const|endpoint|int|float|boolean|string|blob|map|xml|xmlns|json|table|any|stream|identifier)
  ...
  /* ********************************************************** */
  // ExpressionList RARROW (fork | identifier) SEMICOLON
  ...
  public static boolean matchExpression(PsiBuilder b, int l) {
    ...
    boolean r;
    Marker m = enter_section_(b);
    r = consumeTokens(b, 0, BUT, LEFT_BRACE);
  ...
  // typeof (BuiltInTypeName | Expression)
  public static boolean TypeAccessExpression(PsiBuilder b, int l) {
    ...
    p = r; // pin = 1
    r = r && TypeAccessExpression_1(b, l + 1);
    exit_section_(b, l, m, r, p, null);
    return r || p;
  }

  // BuiltInTypeName | Expression
  private static boolean TypeAccessExpression_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "TypeAccessExpression_1")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = BuiltInTypeName(b, l + 1);
    if (!r) r = Expression(b, l + 1, -1);
    exit_section_(b, m, null, r);
    return r;
  }
  ...
  public static boolean FunctionInvocationReference(PsiBuilder b, int l) {
    ...
    r = FunctionInvocationReference_0(b, l + 1);
    r = r && FunctionInvocation(b, l + 1);
    exit_section_(b, l, m, r, false, null);
    return r;
  }
  ...
  // (async)?
  private static boolean FunctionInvocationReference_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "FunctionInvocationReference_0")) return false;
    consumeTokenSmart(b, ASYNC);
    return true;
  }
