...
public class BallerinaParser implements PsiParser, LightPsiParser {
  ...
  /* ********************************************************** */
  // !(int|string|float|boolean|blob|any|function|'}'|';'|var |while|match|foreach|next|break|fork|try|throw|return|abort|fail|lock|xmlns|transaction|if)
  ...
  /* ********************************************************** */
  // !(int|string|float|boolean|blob|any|json|xml|xmlns|map|function|'}'|';'|typedesc|future|await|var|while|match|foreach|next|break|fork|try|throw|return|abort|fail|lock|transaction|if|identifier)
  ...
  /* ********************************************************** */
  // !(DOCUMENTATION_TEMPLATE_START|DEPRECATED_TEMPLATE_START|'@'|public|type|typedesc|struct|service|function|enum|annotation|transformer|const|endpoint|boolean|int|float|string|blob|map|xml|xmlns|json|identifier)
